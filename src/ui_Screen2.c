...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Button2, &ui_img_up_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Button3, &ui_img_left_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Button6, &ui_img_play_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Button7, &ui_img_enter_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui_Label20, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    lv_obj_set_style_bg_img_src(ui_Button9, &ui_img_down_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_flag(ui_Label22, LV_OBJ_FLAG_HIDDEN);     /// Flags
    ...
    lv_label_set_text(ui_Label24, "5");
